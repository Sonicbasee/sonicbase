...
import { h as images, s as PageTitle } from "./sonicbase-CB5emti4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/about-CM7Sy3Sk.js
...
function AboutPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			src: images.studio,
			alt: "A collaborative session at Sonicbase Studios",
			width: 1920,
			height: 1088,
			className: "h-[55vw] max-h-[680px] min-h-[340px] w-full object-cover"
		}),
