...
import { f as fetchArtists, g as fetchDistributions, w as fetchReleases } from "./api-Eeax_ugD.mjs";
import { n as useQuery } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-BDN87vid.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DashboardPage, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-6",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionCard, {
					title: "Recent distribution activity",
					eyebrow: "Operations",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCard, {
						...
						rows: distributions.slice(0, 5).map((d) => ({
							artist: d.artist,
							release: d.release,
							status: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { status: d.status }),
