...
import { a as ShoppingBag, l as Menu, n as X, o as Search, p as Instagram, t as Youtube, x as ArrowRight } from "../_libs/lucide-react.mjs";
import { a as SheetTrigger, i as SheetTitle, n as SheetClose, r as SheetContent, t as Sheet } from "./sheet-BygBrdyb.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sonicbase-Dir2Rrov.js
...
function Header({ artists = [], releases = [] }) {
...
function CartPanel() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: "flex min-h-0 flex-1 flex-col items-center justify-center px-5 pb-5",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, { className: "h-12 w-12 text-muted-foreground/40" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 text-sm text-muted-foreground",
					children: "Browse the shop to find something you love."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetClose, {
					asChild: true,
...
function HeroCarousel({ slides = [] }) {
	...
	if (count === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "relative h-[92vh] min-h-[620px] overflow-hidden bg-primary text-primary-foreground flex items-center justify-center",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Independent Music, Artist-Led"
			})]
		})
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: item.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				className: "h-full w-full bg-muted-foreground/10 flex items-center justify-center text-muted-foreground text-sm",
				children: "No image"
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "pb-2 pr-2",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, { children: item.category }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
...
function NewsGrid({ items = [] }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: items.slice(0, 2).map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NewsFeature, { item }, item.id))
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "grid grid-cols-2 gap-3",
			children: items.slice(2).concat(items.slice(0, 2)).slice(0, 4).map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: loop.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: item.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						height: 1536,
						className: "h-full w-full object-cover"
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-full w-full bg-muted-foreground/10" })
				}, `${item.alt}-${i}`))
			})
		})]
	});
...
//#endregion
export { Logo as a, PillLink as c, SectionHeading as d, Socials as f, HeroCarousel as i, ProductCard as l, Footer as n, NewsGrid as o, Tag as p, Header as r, PageTitle as s, ArtistCard as t, ReleaseCard as u };
