...
import { s as PageTitle, t as ArtistCard } from "./sonicbase-Dir2Rrov.mjs";
import { t as fetchPublicArtists } from "./public-data-SLjy_1a6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/artists-D4SP-Bvo.js
...
function ArtistsPage() {
	...
	const filtered = (0, import_react.useMemo)(() => artists.filter((a) => `${a.name} ${a.genre} ${a.city}`.toLowerCase().includes(query.toLowerCase())), [query, artists]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageTitle, {
		...
		children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: filtered.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArtistCard, { artist: a }, a.id))
