...
const adminNav: DashboardNavItem[] = [
  ...
  { label: "Distribution", path: "/admin/distribution", icon: Building2 },
  { label: "Streams", path: "/admin/streams", icon: TrendingUp },
  { label: "Revenue", path: "/admin/revenue", icon: CreditCard },
  { label: "Reports", path: "/admin/reports", icon: FileText },
  { label: "Contracts", path: "/admin/contracts", icon: BriefcaseBusiness },
  { label: "Legal", path: "/admin/legal", icon: ShieldCheck },
