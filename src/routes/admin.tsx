...
import { DashboardPage, PanelGrid, SectionCard, StatCard, StatusBadge, TableCard } from "@/components/dashboard";
import { adminOverviewStats, adminRevenueData, adminStreamData, distributionRecords, dashboardReleases } from "@/lib/dashboard-data";
